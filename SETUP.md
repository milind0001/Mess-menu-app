# 🥗 Pune Mess Menu App — Setup Guide

This document explains how to set up and run the **Pune Mess Menu App**, a full-stack MERN application with real-time updates, authentication, AI support, and Cloudinary image uploads.
